...
# Bessere im Zweifel nach (Seperator richtig gesetzt, Encoding richtig, sind alle Zahlen auch als Zahlen erkannt worden?).
...
# Berechne den Anteil der jeweiligen Kraftstoffart am Gesamtbestand je Zulassungsbezirk und füge sie dem Datensatz als neue Spalte hinzu.
...
# Tipp: Das Rezept ist filtern, gruppieren, sortieren
...
# Wie viele Autos gibt es in Deutschland insgesamt?


# Erstelle je Kraftstoffart eine Liste mit den Zulassungebezirken, in denen sie den größten und geringsten Anteil haben.
